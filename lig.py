...
class HaftaninMaclari(Screen):
	...
	def __init__(self,**kwargs):
		...
		for i in range(9):	
			...
			self.bilgiler_1 = puandurumu.takim_bilgileri(puandurumu.kluplinkleri[puandurumu.haftaninmaclari[i]["takim_1"]])
			self.bilgiler_2 = puandurumu.takim_bilgileri(puandurumu.kluplinkleri[puandurumu.haftaninmaclari[i]["takim_2"]])
			
			self.kutu_1.add_widget(AsyncImage(source = self.bilgiler_1["klup_logo"]))
			...
			self.kutu_2.add_widget(AsyncImage(source = self.bilgiler_2["klup_logo"]))
